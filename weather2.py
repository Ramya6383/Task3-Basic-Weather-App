...
def data_get():
    city=city_name.get()
    data=requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=193abc6aed9ad8195c231eb0d9d93749").json()
...
com=ttk.Combobox(win,text="WEATHER APP",values=list_name,font=("arial",30,"bold"),textvariable=city_name)
